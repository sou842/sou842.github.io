...
async function Module(moduleArg = {}) {
    ...
    function updateMemoryViews() {
        ...
        Module1["HEAP8"] = HEAP8 = new Int8Array(b);
        Module1["HEAP16"] = HEAP16 = new Int16Array(b);
        Module1["HEAPU8"] = HEAPU8 = new Uint8Array(b);
        Module1["HEAPU16"] = HEAPU16 = new Uint16Array(b);
        Module1["HEAP32"] = HEAP32 = new Int32Array(b);
        Module1["HEAPU32"] = HEAPU32 = new Uint32Array(b);
        Module1["HEAPF32"] = HEAPF32 = new Float32Array(b);
        Module1["HEAPF64"] = HEAPF64 = new Float64Array(b);
    ...
    function initRuntime() {
        ...
        if (!Module1["noFSInit"] && !FS.initialized) FS.init();
        TTY.init();
        wasmExports["D"]();
    ...
    async function createWasm() {
        ...
        if (Module1["instantiateWasm"]) {
            return new Promise((resolve, reject)=>{
                Module1["instantiateWasm"](info, (inst, mod)=>{
    ...
    var exposePublicSymbol = (name, value, numArguments)=>{
        if (Module1.hasOwnProperty(name)) {
            ...
            if (Module1[name].overloadTable.hasOwnProperty(numArguments)) {
    ...
    var FS = {
        ...
        init (input, output, error) {
            FS.initialized = true;
            input ??= Module1["stdin"];
            output ??= Module1["stdout"];
            error ??= Module1["stderr"];
        ...
        createLazyFile (parent, name, url, canRead, canWrite) {
            ...
            if (globalThis.XMLHttpRequest) {
                if ("TURBOPACK compile-time truthy", 1) abort("Cannot do synchronous binary XHRs outside webworkers in modern browsers. Use --embed-file or --preload-file in emcc");
    ...
    FS.staticInit();
    {
        ...
        if (Module1["preloadPlugins"]) preloadPlugins = Module1["preloadPlugins"];
        if (Module1["print"]) out = Module1["print"];
        if (Module1["printErr"]) err = Module1["printErr"];
    ...
    function assignWasmExports(wasmExports) {
        ...
        _malloc = Module1["_malloc"] = wasmExports["H"];
        _free = Module1["_free"] = wasmExports["I"];
        ...
        __indirect_function_table = wasmTable = wasmExports["F"];
    }
    var wasmImports = {
        a: ___cxa_throw,
        v: __abort_js,
    ...
    function run() {
        ...
        function doRun() {
            ...
            Module1["onRuntimeInitialized"]?.();
            postRun();
        }
        if (Module1["setStatus"]) {
            Module1["setStatus"]("Running...");
            setTimeout(()=>{
                setTimeout(()=>Module1["setStatus"](""), 1);
                doRun();
            }, 1);
        } else {
            doRun();
...
//# sourceMappingURL=node_modules_%40splinetool_runtime_build_boolean_0vn7-nl.js.map