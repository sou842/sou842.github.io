...
const navLinks = [
  ...
  { name: "Experience", href: "#how-it-works" },
  { name: "Skills", href: "#expertise" },
  { name: "Projects", href: "#integrations" },
    ...
    >
      <nav
        className={`mx-auto transition-all duration-500 ${isScrolled || isMobileMenuOpen
            ? "bg-background/80 backdrop-blur-xl border border-foreground/10 rounded-full shadow-lg max-w-[1200px]"
      ...
      >
        ...
        >
          ...
          <a href="#" className="flex items-center gap-2 group">
            <span className={`font-medium tracking-tight transition-all duration-500 ${isScrolled ? "text-xl text-foreground" : "text-xl text-white"}`}>Sourav</span>
          </a>
          ...
          <div className="hidden md:flex items-center gap-4">
            <Button
              ...
              asChild
            >
              <a href={portfolio.personal.resumeUrl} target="_blank">
                Resume
              </a>
            </Button>
          </div>
        ...
        <div className="flex flex-col h-full px-8 pt-28 pb-8">
          ...
          >
            <Button
              ...
              asChild
            >
              <a href={`mailto:${portfolio.personal.email}`}>Mail</a>
            </Button>
            <Button
              ...
              asChild
            >
              <a href={portfolio.personal.resumeUrl} target="_blank">Resume</a>
            </Button>
          </div>
        </div>
      </div>
