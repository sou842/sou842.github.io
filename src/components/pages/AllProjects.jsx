...
const AllProjects = () => {
  ...
  return (
    <div className="all-projects-page">
      ...
      {/* Projects Section */}
      <section className="projects-section all-projects">
        <div className="container">
          <div className="section-header">
            <h1 className="page-title">All Projects</h1>
            <p className="section-description">
              Explore my complete portfolio of web applications, mobile solutions, and innovative projects built with modern technologies.
            </p>
          </div>
